var chatInputApplicationCommandMention = require('discord.js').chatInputApplicationCommandMention;
...
module.exports = {
    dialog: {
        ...
        step10option1: {
            name: '???',
            msgColor: Colors.NoraColor,
            message: "Mira algun item que puedas comprar y compralo!\nLos items de principiante son buenos para que empieces.\nPor ahora solo te digo eso, puedes usar ".concat(chatInputApplicationCommandMention('training', CommandIds.Training), " para empezar de verdad tu camino."),
            specialFunction: {
                name: 'openShop',
            },
        },
