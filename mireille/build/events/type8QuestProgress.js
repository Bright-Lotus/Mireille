...
var _a = require('discord.js'), EmbedBuilder = _a.EmbedBuilder, chatInputApplicationCommandMention = _a.chatInputApplicationCommandMention;
var _b = require('firebase/firestore'), getFirestore = _b.getFirestore, doc = _b.doc, setDoc = _b.setDoc, getDocs = _b.getDocs, collection = _b.collection, orderBy = _b.orderBy, query = _b.query;
                                        ...
                                        weeklyQuestsSnap.forEach(function (docSnap) { return __awaiter(_this, void 0, void 0, function () {
                                            ...
                                            return __generator(this, function (_b) {
                                                ...
                                                _loop_2 = function (i) {
                                                    ...
                                                    9 = Level up | DONE
                                                    */
                                                    if ((mission === null || mission === void 0 ? void 0 : mission.type) == 8) {
                                                        querySnapshot.forEach(function (document) { return __awaiter(_this, void 0, void 0, function () {
                                                            var current, missionGoal, quest, progressEmbed, progressEmbed, progressEmbed, completedEmbed;
                                                            var _a, _b;
                                                            var _c;
