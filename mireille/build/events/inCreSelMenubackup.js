...
module.exports = {
    ...
    execute: function (interaction) {
        return __awaiter(this, void 0, void 0, function () {
            var interactionHandlers, interactionType, idSplit, target, abilityID, bowID, equipment, equipmentData, bow, bowStats, equipped, itemPerks_5, equippedEmbed, armorPlateID, equipment, armorPlate, armorPlateStats, equipped, itemPerks_6, equippedEmbed, wandID, equipment, wand, wandStats, equipped, itemPerks_7, equippedEmbed, abilityOrbID, equipment, abilityOrb, equipped, abilityOrbEquipped, playerInfo, ratio, equippedEmbed, consumableID, playerEquipment, consumable, _a, noMoreConsumableEmbed, healEmbed, playerStats, noMoreConsumableEmbed, manaEmbed, swordID, equipment, sword, swordStats, equipped, itemPerks_8, equippedEmbed, playerInfo, idSplit, enemy, enemyHp, enemyAtk, enemySpd, enemyArmor, enemyMagicDurability, enemyElite, enemyXp, enemyGold, turn_1, keywords, keywordsArray_1, enemyUnique_1, activeBattles, errorEmbed, enemyAttackedEmbed_3, messageEmbeds_1, battleStartEmbed, debuffs, idSplit, enemyUnique_2, playerInfo_1, playerAtk, bonus, activeBuffs, replyEmbeds_2, enemyAttackedEmbed_4, chargeEmbed, channel, farmChannel_3, _b, _c, _d, farmChnnl, e_5_1, enemyAttackedEmbed_5, orbUsed, channel, farmChannel_4, _e, _f, _g, farmChnnl, e_6_1, playerEquipment, playerMana, abilityOrbs, abilityOrbsArray, messageEmbeds_2, guildFarmChannels, farmChannel_5, _h, _j, _k, farmChnnl, e_7_1;
            var _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19;
            var _this = this;
            var _20, e_5, _21, _22, _23, e_6, _24, _25, _26, e_7, _27, _28;
            var _29, _30, _31, _32, _33, _34, _35, _36, _37, _38;
            return __generator(this, function (_39) {
                switch (_39.label) {
                    case 0:
                        ...
                        if (!interaction.customId.includes('abilityModal-selectMenu/')) return [3 /*break*/, 2];
                        if (interaction.user.id != interaction.customId.split('/')[1]) {
                            return [2 /*return*/, interaction.reply({ embeds: [ErrorEmbed(EventErrors.NotOwnerOfInteraction)], ephemeral: true })];
                        }
                        // Target handler is for proccessing the target of the ability
                    ...
                    case 1:
                        ...
                        return [2 /*return*/];
                    case 2:
                        if (!interaction.customId.includes('allyTarget-selectMenu/')) return [3 /*break*/, 4];
                        if (interaction.user.id != interaction.customId.split('/')[1]) {
                            return [2 /*return*/, interaction.reply({ embeds: [ErrorEmbed(EventErrors.NotOwnerOfInteraction)], ephemeral: true })];
                        }
                        idSplit = interaction.values[0].split('-');
                    ...
                    case 3:
                        ...
                        return [2 /*return*/];
                    case 4:
                        if (!interaction.customId.includes('inventoryBowsModal-selectMenu/')) return [3 /*break*/, 14];
                        if (interaction.user.id != interaction.customId.split('/')[1]) {
                            return [2 /*return*/, interaction.reply({ embeds: [ErrorEmbed(EventErrors.NotOwnerOfInteraction)], ephemeral: true })];
                        }
                        bowID = interaction.values[0].split('-')[3];
                    ...
                    case 5:
                        ...
                        bow = (_29 = equipmentData.bows) === null || _29 === void 0 ? void 0 : _29["bow".concat(bowID)];
                        if (!bow)
                            return [2 /*return*/];
                        bowStats = bow.stats;
                        return [4 /*yield*/, getDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipped'))];
                    case 6:
                        ...
                        if (!equipped.exists())
                            return [2 /*return*/];
                        if (!((_30 = equipped.data().sword) === null || _30 === void 0 ? void 0 : _30.id)) return [3 /*break*/, 8];
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo'), 'stats.atk', increment(-Math.abs(bowStats.atk)), [{ 'stats.speed': increment(-Math.abs(bowStats.spd)) }])];
                    case 7:
                        _39.sent();
                        _39.label = 8;
                    ...
                    case 10:
                        // Adds the stats of the bow to the player stats
                        _39.sent();
                        if (!(bow === null || bow === void 0 ? void 0 : bow.perks)) return [3 /*break*/, 12];
                        itemPerks_5 = [];
                        Object.values(bow.perks).forEach(function (perk) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                itemPerks_5.push({ perkRatio: perk.ratio, perk: perk.perk });
                                return [2 /*return*/];
                            });
                        }); });
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipped'), 'onAttack', itemPerks_5)];
                    case 11:
                        _39.sent();
                        _39.label = 12;
                    case 12:
                    ...
                    case 14:
                        if (!interaction.customId.includes('inventoryArmorPlatesModal-selectMenu/')) return [3 /*break*/, 24];
                        if (interaction.user.id != interaction.customId.split('/')[1]) {
                            return [2 /*return*/, interaction.reply({ embeds: [ErrorEmbed(EventErrors.NotOwnerOfInteraction)], ephemeral: true })];
                        }
                        armorPlateID = interaction.values[0].split('-')[3];
                    ...
                    case 15:
                        equipment = _39.sent();
                        if (!equipment.exists()) return [3 /*break*/, 23];
                        armorPlate = equipment.data().armorPlates["armorPlate".concat(armorPlateID)];
                        armorPlateStats = armorPlate.stats;
                        return [4 /*yield*/, getDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipped'))];
                    case 16:
                        equipped = _39.sent();
                        if (!equipped.exists()) return [3 /*break*/, 18];
                        if (!((_31 = equipped.data().sword) === null || _31 === void 0 ? void 0 : _31.id)) return [3 /*break*/, 18];
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo'), (_l = {},
                                _l['stats.armor'] = increment(-Math.abs(armorPlateStats.armor)),
                                _l['stats.magicDurability'] = increment(-Math.abs(armorPlateStats.magicDurability)),
                                _l['stats.maxHp'] = increment(-Math.abs(armorPlateStats.maxHp)),
                                _l), { merge: true })];
                    case 17:
                        _39.sent();
                        _39.label = 18;
                    case 18: return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipped'), (_m = {},
                            _m['armorPlate'] = { id: armorPlateID },
                            _m), { merge: true })];
                    case 19:
                        _39.sent();
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo'), (_o = {},
                                _o['stats.armor'] = increment(armorPlateStats.armor),
                                _o['stats.magicDurability'] = increment(armorPlateStats.magicDurability),
                                _o['stats.maxHp'] = increment(Math.abs(armorPlateStats.maxHp)),
                                _o), { merge: true })];
                    case 20:
                        _39.sent();
                        if (!(armorPlate === null || armorPlate === void 0 ? void 0 : armorPlate.perks)) return [3 /*break*/, 22];
                        itemPerks_6 = [];
                        Object.values(armorPlate.perks).forEach(function (perk) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                itemPerks_6.push({ perkRatio: perk.ratio, perk: perk.perk });
                                return [2 /*return*/];
                            });
                        }); });
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipped'), (_p = {},
                                _p['onEnemyAttack'] = itemPerks_6,
                                _p), { merge: true })];
                    case 21:
                        _39.sent();
                        _39.label = 22;
                    ...
                    case 24:
                        if (!interaction.customId.includes('inventoryWandsModal-selectMenu/')) return [3 /*break*/, 36];
                        if (interaction.user.id != interaction.customId.split('/')[1]) {
                            return [2 /*return*/, interaction.reply({ embeds: [ErrorEmbed(EventErrors.NotOwnerOfInteraction)], ephemeral: true })];
                        }
                        wandID = interaction.values[0].split('-')[3];
                    ...
                    case 25:
                        equipment = _39.sent();
                        if (!equipment.exists()) return [3 /*break*/, 35];
                        wand = equipment.data().wands["wand".concat(wandID)];
                        wandStats = wand.stats;
                        return [4 /*yield*/, getDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipped'))];
                    case 26:
                        equipped = _39.sent();
                        if (!equipped.exists()) return [3 /*break*/, 29];
                        if (!((_32 = equipped.data().sword) === null || _32 === void 0 ? void 0 : _32.id)) return [3 /*break*/, 29];
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo'), (_q = {},
                                _q['stats.manaPerAttack'] = increment(-Math.abs(wandStats.mana)),
                                _q), { merge: true })];
                    case 27:
                        _39.sent();
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo'), (_r = {},
                                _r['stats.magicStrength'] = increment(-Math.abs(wandStats.magicStrength)),
                                _r), { merge: true })];
                    case 28:
                        _39.sent();
                        _39.label = 29;
                    case 29: return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipped'), (_s = {},
                            _s['wand'] = { id: wandID },
                            _s), { merge: true })];
                    case 30:
                        _39.sent();
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo'), (_t = {},
                                _t['stats.manaPerAttack'] = increment(wandStats.mana),
                                _t), { merge: true })];
                    case 31:
                        _39.sent();
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo'), (_u = {},
                                _u['stats.magicStrength'] = increment(wandStats.magicStrength),
                                _u), { merge: true })];
                    case 32:
                        _39.sent();
                        if (!(wand === null || wand === void 0 ? void 0 : wand.perks)) return [3 /*break*/, 34];
                        itemPerks_7 = [];
                        Object.values(wand.perks).forEach(function (perk) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                itemPerks_7.push({ perkRatio: perk.ratio, perk: perk.perk });
                                return [2 /*return*/];
                            });
                        }); });
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipped'), (_v = {},
                                _v['onAttack'] = itemPerks_7,
                                _v), { merge: true })];
                    case 33:
                        _39.sent();
                        _39.label = 34;
                    ...
                    case 36:
                        if (!interaction.customId.includes('inventoryAbilityOrbsModal')) return [3 /*break*/, 45];
                        if (interaction.user.id != interaction.customId.split('/')[1]) {
                            return [2 /*return*/, interaction.reply({ embeds: [ErrorEmbed(EventErrors.NotOwnerOfInteraction)], ephemeral: true })];
                        }
                        abilityOrbID = interaction.values[0].split('-')[4];
                    ...
                    case 37:
                        equipment = _39.sent();
                        if (!equipment.exists()) return [3 /*break*/, 44];
                        abilityOrb = equipment.data().abilityOrbs["abilityOrb".concat(abilityOrbID)];
                        return [4 /*yield*/, getDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipped'))];
                    case 38:
                        equipped = _39.sent();
                        if (!equipped.exists()) return [3 /*break*/, 40];
                        if (!((_33 = equipped.data()) === null || _33 === void 0 ? void 0 : _33.abilityOrbs[interaction.customId.split('-')[1]])) return [3 /*break*/, 40];
                        abilityOrbEquipped = equipment.data().abilityOrbs["abilityOrb".concat((_34 = equipped.data()) === null || _34 === void 0 ? void 0 : _34.abilityOrbs[interaction.customId.split('-')[1]])];
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipment'), (_w = {},
                                _w["abilityOrbs.abilityOrb".concat((_35 = equipped.data()) === null || _35 === void 0 ? void 0 : _35.abilityOrbs[interaction.customId.split('-')[1]], ".requiredMana")] = abilityOrbEquipped === null || abilityOrbEquipped === void 0 ? void 0 : abilityOrbEquipped.staticMana,
                                _w), { merge: true })];
                    case 39:
                        _39.sent();
                        _39.label = 40;
                    case 40: return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipped'), (_x = {},
                            _x['abilityOrbs'] = __assign(__assign({}, equipped.data().abilityOrbs), (_y = {}, _y[interaction.customId.split('-')[1]] = abilityOrbID, _y)),
                            _x), { merge: true })];
                    case 41:
                        _39.sent();
                        return [4 /*yield*/, getDoc(doc(db, interaction.user.id, 'PlayerInfo'))];
                    case 42:
                        ...
                        if (interaction.customId.split('-')[1] == 'orb5')
                            ratio -= 0.3;
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipment'), (_z = {},
                                _z["abilityOrbs.abilityOrb".concat(abilityOrbID, ".requiredMana")] = Math.round(abilityOrb.requiredMana * ratio),
                                _z), { merge: true })];
                    case 43:
                        _39.sent();
                        equippedEmbed = new EmbedBuilder()
                    ...
                    case 45:
                        if (!interaction.customId.includes('consumable-selectMenu/')) return [3 /*break*/, 63];
                        if (interaction.user.id != interaction.customId.split('/')[1]) {
                            return [2 /*return*/, interaction.reply({ embeds: [ErrorEmbed(EventErrors.NotOwnerOfInteraction)], ephemeral: true })];
                        }
                        consumableID = interaction.values[0].split('-')[2];
                        return [4 /*yield*/, getDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipment'))];
                    case 46:
                        playerEquipment = _39.sent();
                        if (!playerEquipment.exists()) return [3 /*break*/, 62];
                        consumable = playerEquipment.data().consumables["consumable".concat(consumableID)];
                        _a = consumable.type;
                        switch (_a) {
                            case 'heal': return [3 /*break*/, 47];
                            case 'mana': return [3 /*break*/, 57];
                        }
                        return [3 /*break*/, 62];
                    case 47:
                        if (consumable.consumableAmount == 0) {
                        ...
                        interaction.reply({ embeds: [healEmbed] });
                        return [4 /*yield*/, getDoc(doc(db, interaction.user.id, 'PlayerInfo'))];
                    case 48: return [4 /*yield*/, (_39.sent()).data().stats];
                    case 49:
                        playerStats = _39.sent();
                        if (!(playerStats.hp + consumable.amount > playerStats.maxHp)) return [3 /*break*/, 52];
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo'), (_0 = {},
                                _0['stats.hp'] = playerStats.maxHp,
                                _0), { merge: true })];
                    case 50:
                        _39.sent();
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipment'), (_1 = {},
                                _1["consumables.consumable".concat(consumableID, ".consumableAmount")] = (consumable.consumableAmount != 0) ? increment(-1) : 0,
                                _1), { merge: true })];
                    case 51:
                        _39.sent();
                        return [2 /*return*/];
                    case 52: return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo'), (_2 = {},
                            _2['stats.hp'] = increment(consumable.amount),
                            _2), { merge: true })];
                    case 53:
                        _39.sent();
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipment'), (_3 = {},
                                _3["consumables.consumable".concat(consumableID, ".consumableAmount")] = (consumable.consumableAmount != 0) ? increment(-1) : 0,
                                _3), { merge: true })];
                    case 54:
                        _39.sent();
                        if (!((consumable.consumableAmount - 1) == 0)) return [3 /*break*/, 56];
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipment'), (_4 = {},
                                _4["consumables.consumable".concat(consumableID)] = deleteField(),
                                _4), { merge: true })];
                    case 55:
                        _39.sent();
                        _39.label = 56;
                    case 56: return [3 /*break*/, 62];
                    case 57:
                        if (consumable.consumableAmount == 0) {
                            noMoreConsumableEmbed = new EmbedBuilder()
                                .setTitle('Ya no tienes mas de este consumible')
                        ...
                        manaEmbed = new EmbedBuilder()
                            ...
                            .setDescription("Has obtenido ".concat(bold(consumable.amount), " ").concat(formatEmoji(Icons.Mana)));
                        interaction.reply({ embeds: [manaEmbed] });
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo'), (_5 = {},
                                _5['stats.mana'] = increment(consumable.amount),
                                _5), { merge: true })];
                    case 58:
                        _39.sent();
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipment'), (_6 = {},
                                _6["consumables.consumable".concat(consumableID, ".consumableAmount")] = (consumable.consumableAmount != 0) ? increment(-1) : 0,
                                _6), { merge: true })];
                    case 59:
                        _39.sent();
                        if (!((consumable.consumableAmount - 1) == 0)) return [3 /*break*/, 61];
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipment'), (_7 = {},
                                _7["consumables.consumable".concat(consumableID)] = deleteField(),
                                _7), { merge: true })];
                    case 60:
                        _39.sent();
                        _39.label = 61;
                    ...
                    case 63:
                        if (!interaction.customId.includes('inventorySwordsModal-selectMenu/')) return [3 /*break*/, 75];
                        if (interaction.user.id != interaction.customId.split('/')[1]) {
                            return [2 /*return*/, interaction.reply({ embeds: [ErrorEmbed(EventErrors.NotOwnerOfInteraction)], ephemeral: true })];
                        }
                        swordID = interaction.values[0].split('-')[3];
                    ...
                    case 64:
                        equipment = _39.sent();
                        if (!equipment.exists()) return [3 /*break*/, 74];
                        sword = equipment.data().swords["sword".concat(swordID)];
                        swordStats = sword.stats;
                        return [4 /*yield*/, getDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipped'))];
                    case 65:
                        equipped = _39.sent();
                        if (!equipped.exists()) return [3 /*break*/, 68];
                        if (!((_36 = equipped.data().sword) === null || _36 === void 0 ? void 0 : _36.id)) return [3 /*break*/, 68];
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo'), (_8 = {},
                                _8['stats.atk'] = increment(-Math.abs(swordStats.atk)),
                                _8), { merge: true })];
                    case 66:
                        _39.sent();
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo'), (_9 = {},
                                _9['stats.speed'] = increment(-Math.abs(swordStats.spd)),
                                _9), { merge: true })];
                    case 67:
                        _39.sent();
                        _39.label = 68;
                    case 68: return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipped'), (_10 = {},
                            _10['sword'] = { id: swordID },
                            _10), { merge: true })];
                    case 69:
                        _39.sent();
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo'), (_11 = {},
                                _11['stats.atk'] = increment(swordStats.atk),
                                _11), { merge: true })];
                    case 70:
                        _39.sent();
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo'), (_12 = {},
                                _12['stats.speed'] = increment(swordStats.spd),
                                _12), { merge: true })];
                    case 71:
                        _39.sent();
                        if (!(sword === null || sword === void 0 ? void 0 : sword.perks)) return [3 /*break*/, 73];
                        itemPerks_8 = [];
                        Object.values(sword.perks).forEach(function (perk) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                itemPerks_8.push({ perkRatio: perk.ratio, perk: perk.perk });
                                return [2 /*return*/];
                            });
                        }); });
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipped'), (_13 = {},
                                _13['onAttack'] = itemPerks_8,
                                _13), { merge: true })];
                    case 72:
                        _39.sent();
                        _39.label = 73;
                    ...
                    case 75:
                        if (!interaction.customId.includes('battleFlow-selectMenu/')) return [3 /*break*/, 80];
                        if (interaction.user.id != interaction.customId.split('/')[1]) {
                            return [2 /*return*/, interaction.reply({ embeds: [ErrorEmbed(EventErrors.NotOwnerOfInteraction)], ephemeral: true })];
                        }
                        return [4 /*yield*/, getDoc(doc(db, interaction.user.id, 'PlayerInfo'))];
                    case 76:
                        ...
                        keywords.forEach(function (element) {
                            ...
                            if (keywordObj.type !== 0 && keywordObj.subtype !== 0) {
                                keywordsArray_1.push(keywordObj);
                            }
                        });
                        return [4 /*yield*/, getDoc(doc(db, interaction.user.id, 'ActiveBattles'))];
                    case 77:
                        activeBattles = _39.sent();
                        if (activeBattles.exists()) {
                            if ((((_37 = activeBattles.data()) === null || _37 === void 0 ? void 0 : _37.battles.amount) + 1) > 3) {
                                errorEmbed = ErrorEmbed(EventErrors.BattleLimitReached);
                                return [2 /*return*/, interaction.reply({ embeds: [errorEmbed] })];
                            }
                            enemyUnique_1 = activeBattles.data().battles.amount;
                        }
                        enemyAttackedEmbed_3 = new EmbedBuilder()
                            .setColor('Red')
                            .addFields({ name: "_                          _".concat(formatEmoji(Icons.EnemyAttack), "                         _ _\n\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557\n\u2588     ").concat(bold('Tu enemigo ha atacado'), "    \u2588 \n\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584"), value: '_ _' });
                        messageEmbeds_1 = [];
                        battleStartEmbed = new EmbedBuilder()
                            ...
                            .setDescription('Escribe "attack" de nuevo para atacar a este enemigo.')
                            .setColor('Green');
                        messageEmbeds_1.push(battleStartEmbed);
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'ActiveBattles'), (_14 = {},
                                _14['battles.amount'] = increment(1),
                                _14), { merge: true })];
                    case 78:
                        _39.sent();
                        debuffs = [];
                        ...
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'ActiveBattles'), (_15 = {},
                                _15["battles.battle".concat(enemyUnique_1)] = {
                                    enemyId: enemy,
                                    enemyHp: enemyHp,
                                    enemyMaxHp: enemyHp,
                                    enemyAtk: enemyAtk,
                                    ...
                                    enemyGold: enemyGold,
                                    turn: turn_1,
                                    enemyUnique: enemyUnique_1,
                                    keywords: keywordsArray_1,
                                    debuffs: debuffs,
                                    turnsUntilAbility: 3,
                                },
                                _15), { merge: true }).then(function () { return __awaiter(_this, void 0, void 0, function () {
                                var channel, farmChannel, _a, _b, _c, farmChnnl, e_8_1;
                                var _this = this;
                                var _d, e_8, _e, _f;
                                return __generator(this, function (_g) {
                                    switch (_g.label) {
                                        case 0:
                                            if (!(turn_1 == 'enemy')) return [3 /*break*/, 15];
                                            return [4 /*yield*/, getDoc(doc(db, interaction.guildId, 'FarmChannels'))];
                                        case 1:
                                            channel = _g.sent();
                                            farmChannel = void 0;
                                        ...
                                        case 13:
                                            console.log('🚀 ~ file: interactionCreateSelectMenu.js:284 ~ forawait ~ farmChannel', interaction.channelId, farmChannel);
                                            return [4 /*yield*/, attack(interaction.user, enemyUnique_1, interaction.client, farmChannel).then(function (results) { return __awaiter(_this, void 0, void 0, function () {
                                                    return __generator(this, function (_a) {
                                                        if (results.enemyAttacked) {
                                                            enemyAttackedEmbed_3.addFields({ name: bold('<             Daño recibido               >'), value: "".concat(results.damageReceived) }, { name: bold('<              Vida restante               >'), value: "".concat(results.remainingHp) });
                                                            messageEmbeds_1.push(enemyAttackedEmbed_3);
                                                        }
                                                        return [2 /*return*/];
                                                    });
                                                }); }).catch(function (results) { return __awaiter(_this, void 0, void 0, function () {
                                                    ...
                                                    return __generator(this, function (_b) {
                                                        switch (_b.label) {
                                                            case 0:
                                                                enemyAttackedEmbed_3.addFields({ name: bold('<             Daño recibido               >'), value: "".concat(results.damageReceived) }, { name: bold('<              Vida restante               >'), value: '0' });
                                                                deadEmbed = new EmbedBuilder()
                                                                    .setTitle('Has muerto!')
                                                                    .setColor('Red')
                                                                    .setDescription("No puedes hacer nada hasta que revivas.\n".concat(bold('Reviviras en 8 mega-revers.')));
                    ...
                    case 79:
                        _39.sent();
                        return [2 /*return*/, interaction.reply({ embeds: messageEmbeds_1 })];
                    case 80:
                        if (!interaction.customId.includes('battleFlow-selectMenu-activeBattle/')) return [3 /*break*/, 138];
                        console.log(interaction.customId.split('-'), 'debug202');
                        if (interaction.user.id != interaction.customId.split('/')[1]) {
                            return [2 /*return*/, interaction.reply({ embeds: [ErrorEmbed(EventErrors.NotOwnerOfInteraction)], ephemeral: true })];
                        }
                    ...
                    case 81:
                        ...
                        idSplit = interaction.values[0].split('-');
                        console.log(idSplit, 'interaction debug select flow');
                        enemyUnique_2 = idSplit[4];
                        console.log(enemyUnique_2, 'debugunique');
                        return [4 /*yield*/, getDoc(doc(db, interaction.user.id, 'PlayerInfo'))];
                    case 82:
                        playerInfo_1 = _39.sent();
                        if (playerInfo_1.data().attackOnCooldown) {
                            return [2 /*return*/, interaction.editReply({ embeds: [ErrorEmbed(EventErrors.AttackOnCooldown, "Puedes atacar ".concat(time(new Timestamp(playerInfo_1.data().attackCooldown.seconds, playerInfo_1.data().attackCooldown.nanoseconds).toDate(), TimestampStyles.RelativeTime)))], ephemeral: true })];
                        }
                        console.log(idSplit[1], 'love');
                        if (!(idSplit[1] == 'chargeAttack')) return [3 /*break*/, 102];
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'ActiveBattles'), (_16 = {},
                                _16["battles.battle".concat(idSplit[4], ".turn")] = 'enemy',
                                _16), { merge: true })];
                    case 83:
                        _39.sent();
                        return [4 /*yield*/, getDoc(doc(db, interaction.user.id, 'PlayerInfo'))];
                    case 84: return [4 /*yield*/, (_39.sent()).data().stats.atk];
                    case 85:
                        playerAtk = _39.sent();
                        bonus = playerAtk / 100 * 200;
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo'), (_17 = {},
                                _17['stats.atk'] = bonus,
                                _17), { merge: true })];
                    case 86:
                        _39.sent();
                        ...
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'PlayerInfo'), (_18 = {},
                                _18['activeBuffs'] = arrayUnion(activeBuffs),
                                _18), { merge: true })];
                    case 87:
                        _39.sent();
                        replyEmbeds_2 = [];
                        enemyAttackedEmbed_4 = new EmbedBuilder()
                            .setColor('Red')
                            .addFields({ name: "_                          _".concat(formatEmoji(Icons.EnemyAttack), "                         _ _\n\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557\n\u2588     ").concat(bold('Tu enemigo ha atacado'), "    \u2588 \n\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584"), value: '_ _' });
                        chargeEmbed = new EmbedBuilder()
                            .setTitle('Has cargado un ataque poderoso contra el enemigo')
                            .setDescription('Atacalo de nuevo!')
                            .setColor('Red');
                        replyEmbeds_2.push(chargeEmbed);
                        return [4 /*yield*/, getDoc(doc(db, interaction.guildId, 'FarmChannels'))];
                    case 88:
                        channel = _39.sent();
                        _39.label = 89;
                    case 89:
                        _39.trys.push([89, 94, 95, 100]);
                        _b = true, _c = __asyncValues(Object.values(channel.data()));
                        _39.label = 90;
                    case 90: return [4 /*yield*/, _c.next()];
                    case 91:
                        if (!(_d = _39.sent(), _20 = _d.done, !_20)) return [3 /*break*/, 93];
                        _22 = _d.value;
                        _b = false;
                        farmChnnl = _22;
                        if (farmChnnl.id == interaction.channelId) {
                            farmChannel_3 = farmChnnl;
                        }
                        _39.label = 92;
                    case 92:
                        _b = true;
                        return [3 /*break*/, 90];
                    case 93: return [3 /*break*/, 100];
                    case 94:
                        e_5_1 = _39.sent();
                        e_5 = { error: e_5_1 };
                        return [3 /*break*/, 100];
                    case 95:
                        _39.trys.push([95, , 98, 99]);
                        if (!(!_b && !_20 && (_21 = _c.return))) return [3 /*break*/, 97];
                        return [4 /*yield*/, _21.call(_c)];
                    case 96:
                        _39.sent();
                        _39.label = 97;
                    ...
                    case 98:
                        ...
                        return [7 /*endfinally*/];
                    case 99: return [7 /*endfinally*/];
                    case 100: return [4 /*yield*/, attack(interaction.user, idSplit[4], interaction.client, farmChannel_3).then(function (results) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                if (results.enemyAttacked) {
                                    enemyAttackedEmbed_4.addFields({ name: bold('<             Daño recibido               >'), value: "".concat(results.damageReceived) }, { name: bold('<              Vida restante               >'), value: "".concat(results.remainingHp) });
                                    replyEmbeds_2.push(enemyAttackedEmbed_4);
                                }
                                return [2 /*return*/];
                            });
                        }); }).catch(function (results) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        enemyAttackedEmbed_4.addFields({ name: bold('<             Daño recibido               >'), value: "".concat(results.damageReceived) }, { name: bold('<              Vida restante               >'), value: '0' });
                                        deadEmbed = new EmbedBuilder()
                                            .setTitle('Has muerto!')
                                            .setColor('Red')
                                            .setDescription("No puedes hacer nada hasta que revivas.\n".concat(bold('Reviviras en 8 mega-revers.')));
                    ...
                    case 101:
                        _39.sent();
                        interaction.editReply({ embeds: replyEmbeds_2 });
                        return [2 /*return*/];
                    case 102:
                        if (!(idSplit[1] === 'ability')) return [3 /*break*/, 123];
                        if (!(((_38 = idSplit[6]) === null || _38 === void 0 ? void 0 : _38.trim()) != '')) return [3 /*break*/, 119];
                        enemyAttackedEmbed_5 = new EmbedBuilder()
                            .setColor('Red')
                            .addFields({ name: "_                          _".concat(formatEmoji(Icons.EnemyAttack), "                         _ _\n\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557\n\u2588     ").concat(bold('Tu enemigo ha atacado'), "    \u2588 \n\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584"), value: '_ _' });
                        orbUsed = new EmbedBuilder()
                            .setTitle('Orbe usada')
                    ...
                    case 103:
                        _39.sent();
                        return [4 /*yield*/, updateDoc(doc(db, interaction.user.id, 'ActiveBattles'), (_19 = {},
                                _19["battles.battle".concat(idSplit[4], ".turn")] = 'enemy',
                                _19), { merge: true })];
                    case 104:
                        _39.sent();
                        return [4 /*yield*/, getDoc(doc(db, interaction.guildId, 'FarmChannels'))];
                    case 105:
                        ...
                        _39.label = 106;
                    case 106:
                        _39.trys.push([106, 111, 112, 117]);
                        _e = true, _f = __asyncValues(Object.values(channel.data()));
                        _39.label = 107;
                    case 107: return [4 /*yield*/, _f.next()];
                    case 108:
                        if (!(_g = _39.sent(), _23 = _g.done, !_23)) return [3 /*break*/, 110];
                        _25 = _g.value;
                        _e = false;
                        farmChnnl = _25;
                        if (farmChnnl.id == interaction.channelId) {
                            farmChannel_4 = farmChnnl;
                        }
                        _39.label = 109;
                    case 109:
                        _e = true;
                        return [3 /*break*/, 107];
                    case 110: return [3 /*break*/, 117];
                    case 111:
                        e_6_1 = _39.sent();
                        e_6 = { error: e_6_1 };
                        return [3 /*break*/, 117];
                    case 112:
                        _39.trys.push([112, , 115, 116]);
                        if (!(!_e && !_23 && (_24 = _f.return))) return [3 /*break*/, 114];
                        return [4 /*yield*/, _24.call(_f)];
                    case 113:
                        _39.sent();
                        _39.label = 114;
                    ...
                    case 117: return [4 /*yield*/, attack(interaction.user, idSplit[4], interaction.client, farmChannel_4).then(function (results) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                if (results.enemyAttacked) {
                                    enemyAttackedEmbed_5.addFields({ name: bold('<             Daño recibido               >'), value: "".concat(results.damageReceived) }, { name: bold('<              Vida restante               >'), value: "".concat(results.remainingHp) });
                                    messageEmbeds_2.push(enemyAttackedEmbed_5);
                                }
                                return [2 /*return*/];
                            });
                        }); }).catch(function (results) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        enemyAttackedEmbed_5.addFields({ name: bold('<             Daño recibido               >'), value: "".concat(results.damageReceived) }, { name: bold('<              Vida restante               >'), value: '0' });
                                        deadEmbed = new EmbedBuilder()
                                            .setTitle('Has muerto!')
                                            .setColor('Red')
                                            .setDescription("No puedes hacer nada hasta que revivas.\n".concat(bold('Reviviras en 8 mega-revers.')));
                    ...
                    case 118:
                        _39.sent();
                        return [2 /*return*/];
                    case 119: return [4 /*yield*/, getDoc(doc(db, interaction.user.id, 'PlayerInfo/Inventory/Equipment'))];
                    case 120:
                        playerEquipment = _39.sent();
                        if (!playerEquipment.exists()) return [3 /*break*/, 122];
                        if (!playerInfo_1.exists()) return [3 /*break*/, 122];
                        playerMana = playerInfo_1.data().stats.mana;
                        abilityOrbs = playerEquipment.data().abilityOrbs;
                        abilityOrbsArray = Object.values(abilityOrbs).filter(function (element) { return (typeof element != 'number'); });
                        return [4 /*yield*/, pagination('abilityOrbs', abilityOrbsArray, 1, interaction.user, { currentMana: playerMana, enemyUnique: enemyUnique_2 }).then(function (results) {
                                return interaction.editReply({ embeds: [results.embed], components: [results.paginationRow, results.selectMenuRow] });
                            })];
                    case 121:
                        _39.sent();
                    ...
                    case 123:
                        ...
                        return [4 /*yield*/, getDoc(doc(db, interaction.guildId, 'FarmChannels'))];
                    case 124:
                        guildFarmChannels = _39.sent();
                        _39.label = 125;
                    case 125:
                        _39.trys.push([125, 130, 131, 136]);
                        _h = true, _j = __asyncValues(Object.values(guildFarmChannels.data()));
                        _39.label = 126;
                    case 126: return [4 /*yield*/, _j.next()];
                    case 127:
                        if (!(_k = _39.sent(), _26 = _k.done, !_26)) return [3 /*break*/, 129];
                        _28 = _k.value;
                        _h = false;
                        farmChnnl = _28;
                        if (farmChnnl.id == interaction.channelId) {
                            farmChannel_5 = farmChnnl;
                        }
                        _39.label = 128;
                    case 128:
                        _h = true;
                        return [3 /*break*/, 126];
                    case 129: return [3 /*break*/, 136];
                    case 130:
                        e_7_1 = _39.sent();
                        e_7 = { error: e_7_1 };
                        return [3 /*break*/, 136];
                    case 131:
                        _39.trys.push([131, , 134, 135]);
                        if (!(!_h && !_26 && (_27 = _j.return))) return [3 /*break*/, 133];
                        return [4 /*yield*/, _27.call(_j)];
                    case 132:
                        _39.sent();
                        _39.label = 133;
                    case 133: return [3 /*break*/, 135];
                    case 134:
                        if (e_7) throw e_7.error;
                        return [7 /*endfinally*/];
                    case 135: return [7 /*endfinally*/];
                    case 136: return [4 /*yield*/, attack(interaction.user, enemyUnique_2, interaction.client, farmChannel_5).then(function (results) { return __awaiter(_this, void 0, void 0, function () {
                            var killedEmbed, splitEmbed, damageDone, damageEmbed, enemyAttackedEmbed;
                            var _this = this;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 4:
                                        ...
                                        damageEmbed = new EmbedBuilder()
                                            ...
                                            .setColor('Blue')
                                            .addFields({ name: bold('<                Daño hecho                 >'), value: damageDone }, { name: bold('<   Vida restante del enemigo  >'), value: "".concat(results.enemyHpRemaining, "\n\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584") }, { name: "\u2588   ".concat(bold('Has atacado al enemigo'), "    \u2588\n\u255A\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u255D\n _                        _ ").concat(formatEmoji(Icons.PlayerAttack), "                         _ _ \n"), value: '_ _' });
                                        messageEmbeds_2.push(damageEmbed);
                                        enemyAttackedEmbed = new EmbedBuilder()
                                            .setColor('Red')
                                            .addFields({ name: "_                          _".concat(formatEmoji(Icons.EnemyAttack), "                         _ _\n\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557\n\u2588     ").concat(bold('Tu enemigo ha atacado'), "    \u2588 \n\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584"), value: '_ _' });
                                        return [4 /*yield*/, attack(interaction.user, enemyUnique_2, interaction.client, farmChannel_5).then(function (resultsEnemy) { return __awaiter(_this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    if (resultsEnemy.enemyAttacked) {
                                                        enemyAttackedEmbed.addFields({ name: bold('<             Daño recibido               >'), value: "".concat(resultsEnemy.damageReceived) }, { name: bold('<              Vida restante               >'), value: "".concat(resultsEnemy.remainingHp) });
                                                        messageEmbeds_2.push(enemyAttackedEmbed);
                                                    }
                                                    else {
                                                        enemyAttackedEmbed
                                                            .setColor('#D4D4D4')
                                                            .setFields({ name: "_                          _".concat(formatEmoji(Icons.CantAttack), "                         _ _\n\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557\n\u2588     ").concat(bold('Tu enemigo no te ataco'), "    \u2588 \n\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584\u2584"), value: '_ _' }, { name: bold('<             Daño recibido               >'), value: '0' }, { name: bold('<              Vida restante               >'), value: "".concat(playerInfo_1.data().stats.hp) });
                                                        messageEmbeds_2.push(enemyAttackedEmbed);
                                                    }
                                                    return [2 /*return*/];
                                                });
                                    ...
                                    case 5:
                                        _a.sent();
                                        return [4 /*yield*/, interaction.editReply({ embeds: messageEmbeds_2 })];
                                    case 6: return [2 /*return*/, _a.sent()];
                                }
                            });
                        }); }).catch(function (results) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    case 137:
                        ...
                        return [2 /*return*/];
                    case 138:
                        if (!interaction.customId.includes('class-select/')) return [3 /*break*/, 141];
                        if (interaction.user.id != interaction.customId.split('/')[1]) {
                            return [2 /*return*/, interaction.reply({ embeds: [ErrorEmbed(EventErrors.NotOwnerOfInteraction)], ephemeral: true })];
                        }
                        return [4 /*yield*/, interaction.deferUpdate()];
                    ...
                    case 140:
                        _39.sent();
                        return [2 /*return*/];
                    case 141: return [4 /*yield*/, interaction.deferUpdate()];
                    case 142:
                        _39.sent();
