    ...
    switch (errorCode) {
        ...
        case EventErrors.PlayerNotRegistered:
            return new EmbedBuilder()
                ...
                .setDescription("Puedes usar ".concat(chatInputApplicationCommandMention('register', CommandIds.Register), " para jugar en el evento!"));
...
module.exports = { EventErrors: EventErrors, ErrorEmbed: ErrorEmbed };
export {};
