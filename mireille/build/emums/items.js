var swords = {
    ...
    sword8: {
        ...
        perks: {
            perk1: {
                perk: 'mark',
                perkDesc: 'Tus ataques marcan a los enemigos, atacalos de nuevo para explotar la marca y hacer **20% de tu ATK**.',
    ...
    sword9: {
        ...
        perks: {
            perk1: {
                perk: 'freeze',
                perkDesc: 'Tus ataques congelan al enemigo, quitandoles **10 + 15% ATK** de armadura.',
    ...
    sword10: {
        ...
        perks: {
            perk1: {
                perk: 'freeze',
                perkDesc: 'Tus ataques congelan al enemigo, quitandoles **13 + 20% ATK** de armadura.',
    ...
    sword11: {
        ...
        perks: {
            perk1: {
                perk: 'burn',
                perkDesc: 'Tus ataques incendian a los enemigos en fuego infernal por **15% de tu ATK**.',
    ...
    sword12: {
        ...
        perks: {
            perk1: {
                perk: 'burn',
                perkDesc: 'Tus ataques encienden a los enemigos en fuego magico por **17% de tu ATK**.',
    ...
    sword13: {
        ...
        perks: {
            perk1: {
                perk: 'burn',
                perkDesc: 'La llama del phoenix eterno inflama a tus enemigos por **23% de tu ATK** en cada ataque',
    ...
    sword20: {
        ...
        perks: {
            perk1: {
                perk: 'gainGold',
                perkDesc: 'Tus ataques llenos de riqueza te dan **4 de ORO** permanente.',
                perkName: 'Rich Money',
                perkRatio: 4,
            },
        },
...
var wands = {
    ...
    wand2: {
        ...
        perks: {
            perk1: {
                ...
                perkDesc: 'Tus ataques te dan **4 de Magic STRENGTH** hasta matar al enemigo.',
    ...
    wand5: {
        ...
        perks: {
            perk1: {
                perk: 'starStrike',
                perkDesc: 'Tus ataques hacen **10% de Magic STRENGTH** adicional con el poder de las estrellas.',
                perkName: 'Stars Aid',
                perkRatio: 10,
            },
        },
    ...
    wand6: {
        ...
        perks: {
            perk1: {
                perk: 'freezeFire',
                perkDesc: 'Tus ataques le quitan **5% de Magic STRENGTH** de armadura al enemigo; Haces 10 de daño extra.',
    ...
    wand9: {
        ...
        perks: {
            perk1: {
                perk: 'mark',
                perkDesc: 'Tus ataques marcan a los enemigos, atacalos de nuevo para explotar la marca y hacer **30% de tu Magic STRENGTH**.',
    ...
    wand11: {
        ...
        perks: {
            perk1: {
                perk: 'natureStrike',
                perkDesc: 'Tus ataques hacen **20% de Magic STRENGTH** adicional con el poder de Gaia.',
    ...
    wand12: {
        ...
        perks: {
            perk1: {
                perk: 'burn',
                perkDesc: 'Tus ataques queman en fuego furioso a los enemigos por **25% Magic STRENGTH**.',
    ...
    wand13: {
        ...
        perks: {
            perk1: {
                perk: 'burn',
                perkDesc: 'Tus ataques queman en fuego calmado a los enemigos por **30% Magic STRENGTH**.',
    ...
    wand14: {
        ...
        perks: {
            perk1: {
                perk: 'freeze',
                perkDesc: 'Tus ataques congelan al enemigo en hielo loco, quitandoles **10 + 20% Magic STRENGTH** de armadura.',
    ...
    wand17: {
        ...
        perks: {
            perk1: {
                perk: 'thunderStrike',
                perkDesc: 'Tus ataques hacen **20% de Magic STRENGTH** adicional con el poder del TRUENO.',
    ...
    wand18: {
        ...
        perks: {
            perk1: {
                perk: 'sunStrike',
                perkDesc: 'Tus ataques hacen **25% de Magic STRENGTH** adicional con el poder del SOL',
                perkName: 'Sun Burn',
                perkRatio: 25,
            },
        },
    ...
    wand20: {
        ...
        perks: {
            perk1: {
                perk: 'gainGold',
                perkDesc: 'Tus ataques te dan **4 de ORO** permanente.',
...
var bows = {
    ...
    bow4: {
        ...
        perks: {
            perk1: {
                perk: 'freeze',
                perkDesc: 'Tus ataques congelan al enemigo, quitandoles **5 + 12% ATK** de armadura.',
    ...
    bow10: {
        ...
        perks: {
            perk1: {
                perk: 'freezeFire',
                perkDesc: 'Tus ataques le quitan **5% de ATK** de armadura al enemigo; Haces 10 de daño extra.',
    ...
    bow12: {
        ...
        perks: {
            perk1: {
                perk: 'mark',
                perkDesc: 'Tus ataques marcan a los enemigos, atacalos de nuevo para explotar la marca y hacer **30% de tu ATK**.',
    ...
    bow14: {
        ...
        perks: {
            perk1: {
                perk: 'thunderStrike',
                perkDesc: 'Tus ataques hacen **20% de ATK** adicional con el poder de ZEUS.',
    ...
    bow16: {
        ...
        perks: {
            perk1: {
                perk: 'starStrike',
                perkDesc: 'Tus ataques hacen **30% de ATK** adicional con el poder de las estrellas.',
                perkName: 'Star rain',
                perkRatio: 30,
            },
        },
    ...
    bow19: {
        ...
        perks: {
            perk1: {
                perk: 'gainGold',
                perkDesc: 'Tus ataques llenos de riqueza te dan **5 de ORO** permanente.',
...
var armorPlates = {
    ...
    armorPlate3: {
        ...
        perks: {
            perk1: {
                perk: 'thornmail',
                perkDesc: 'Cuanto tu enemigo te ataque, le devuelves **5 + 20% ARMOR** de daño.',
    ...
    armorPlate6: {
        ...
        perks: {
            perk1: {
                perk: 'freeze',
                perkDesc: 'Los ataques de tu enemigo lo congelan, quitandoles **7% de tu ARMOR** al enemigo.',
    ...
    armorPlate8: {
        ...
        perks: {
            perk1: {
                perk: 'thornmail',
                perkDesc: 'Cuanto tu enemigo te ataque, los quemas, devolviendoles **8 + 21% ARMOR** de daño.',
    ...
    armorPlate11: {
        ...
        perks: {
            perk1: {
                perk: 'thornmail',
                perkDesc: 'Cuanto tu enemigo te ataque, le devuelves **10 + 23% ARMOR** de daño.',
    ...
    armorPlate15: {
        ...
        perks: {
            perk1: {
                perk: 'thornmail',
                perkDesc: 'Cuanto tu enemigo te ataque, la armadura lo atacara de vuelta, haciendole **15 + 25% ARMOR** de daño.',
    ...
    armorPlate16: {
        ...
        perks: {
            perk1: {
                perk: 'mark',
                perkDesc: 'Los ataques de tus enemigos los marcan, atacalos para explotar la marca y hacer **25% de tu ARMOR**.',
    ...
    armorPlate17: {
        ...
        perks: {
            perk1: {
                perk: 'gainGold',
                perkDesc: 'Los ataques de tus enemigos hace que tu armadura les robe **4 de ORO**.',
    ...
    armorPlate19: {
        ...
        perks: {
            perk1: {
                perk: 'dodge',
                perkDesc: 'Cada ataque de tu enemigo, hay un chance del 40% que tu armadura te envuelva en sombras, esquivando el ataque.',
