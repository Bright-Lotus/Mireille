import { AbilityOrbs, ArmorPlates, Bows, Consumables, Swords, Wands } from '../types/item.js';
...
} as const satisfies Bows;

const armorPlates: ArmorPlates = {
    armorPlate1: {
        price: 1,
        minLvl: 1,
        name: 'Stone Plate',
...
} as const satisfies ArmorPlates;

const EnchanterAbilityOrbs: AbilityOrbs = {
    abilityOrb1: {
        ratio: '50/50-75',
        ability: 'strike',
        requiredMana: 175,
...
} as const satisfies AbilityOrbs;

const WarriorAbilityOrbs: AbilityOrbs = {
    abilityOrb1: {
        ratio: '20/20-80',
...
} as const satisfies Consumables;

export { swords, wands, bows, armorPlates, EnchanterAbilityOrbs, WarriorAbilityOrbs, consumables };
